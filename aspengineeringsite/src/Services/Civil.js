    ...
    return (
        <>
            ...
            <div class="col-12 mt-40">
                ...
                <div class="row mt-40">
                    <div class="col-lg-4 col-md-6 mb-30"> <Scrollanimation animateIn="fadeInLeft" > <img class="rounded-10 w-100" src={require("../images/gallery/project_inner_3.jpg")} alt="project" /> </Scrollanimation></div>
                    <div class="col-lg-4 col-md-6 mb-30"> <Scrollanimation animateIn="slideInUp" > <img class="rounded-10 w-100" src={require("../images/gallery/project_inner_4.jpg")} alt="project" /> </Scrollanimation> </div>
                    <div class="col-lg-4 col-md-6 mb-30"> <Scrollanimation animateIn="fadeInRight"> <img class="rounded-10 w-100" src={require("../images/gallery/project_inner_5.jpg")} alt="project" /> </Scrollanimation> </div>
                </div>
